    ...
    public class ordersRepository
    {
        ...
        public IEnumerable<OrderMaster> getOrders()
        {
            var allOrders =(from orders in context.Orders
                             ...
                             orderby orders.Id 
                                select new OrderMaster{orderId=orders.Id,orderDate= (DateTime)orders.OrderDate,userId= (int)orders.UserId,
                                 firstName=od.FirstName,lastName=od.LastName,email=od.Email,
                                 address = od.Address,
                                 city = od.City,
                                 zip = od.Zip,
